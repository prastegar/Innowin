...
class SignInForm extends Component {
  ...
  _onSubmit = (values) => {
    ...
    const promise = new Promise((resolve, reject) => signIn({username:values.username, password:values.password, rememberMe:values.rememberMe, reject}))
    return promise
      .catch(
        (errorMessage) => {
