...
var getDragHandleRef = function getDragHandleRef(draggableRef) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (el instanceof SVGElement) {
      process.env.NODE_ENV !== "production" ? invariant(false, "A drag handle cannot be an SVGElement: it has inconsistent focus support\n\n        More information: https://github.com/atlassian/react-beautiful-dnd/tree/master/docs/guides/dragging-svgs.md") : invariant(false);
    }
  }
